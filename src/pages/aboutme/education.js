      ...
      <Row className="my-edu">
        <Col span={18} push={6} className="right">
          ...
          <ul>
            ...
            <li>Organizer of Volunteer Campaign at Mid-Autumn Festival 2017.</li>
            <li>Member of communication team for BONJOUR UIT - Welcome New Joiner 2018.</li>

          </ul>
        </Col>
        <Col span={6} pull={18} className="left">
          <div>
            <h4><i>University of Information Technology VNU-HCM</i></h4>
            <p>July 2019 – Present</p>
            <p><i>Major: </i>Information System</p>
            <p><i>GPA: </i>7.11</p>
          </div>
        </Col>
      </Row>
