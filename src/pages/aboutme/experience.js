    ...
    <div className="container exp-container">
      ...
      <Row className="my-exp">
        ...
        <Col span={6} pull={18} className="left">
          <div>
            <h4><i>Sneaker Store App <br /> (The School Project)</i></h4>
      ...
      <Row className="my-exp">
        <Col span={18} push={6} className="right">
          ...
          <h4><i>Duties and responsibilities</i></h4>
          <ul>
            <li> Research and development with NestJS, MongoDB, ReactJS, MobX, GraphQL…</li>
        ...
        <Col span={6} pull={18} className="left">
          <div>
            <h4><i>Pet Store Website <br /> (The School Project)</i></h4>
