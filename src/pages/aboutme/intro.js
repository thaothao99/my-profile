      ...
      <Row className="row-inf">
        <Col span={18} push={6} className="right">
          ...
          <p>
            ...
            utilize my technical, database, management skills for the growth of
            the organization as well as to enhance my knowledge and working.
          </p>
          <h4>
            <i>Qualification</i>
          </h4>
          <ul>
            ...
            <li>
              Knowledge about NodeJS especially with framework like NestJS.
            </li>
        ...
        <Col span={6} pull={18} className="left">
          <p>
            <Avatar src={avt} size={200} shape="circle"></Avatar>
          </p>
          {/* <p><i>Nickname: </i>Bowny</p> */}
          {/* <p>
            <i>Birhday: </i>16/05/199
          </p> */}
        </Col>
      </Row>
    </div>
